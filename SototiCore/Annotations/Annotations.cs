...
namespace SototiCore.Annotations
{
	/// <summary>
	...
	/// <list>
	/// <item><c>NotifyChanged("IBarcode")</c></item>
	/// <item><c>NotifyChanged(() => IBarcode)</c></item>
	/// <item><c>NotifyChanged((VM x) => x.IBarcode)</c></item>
	/// <item><c>SetProperty(ref myField, value, "IBarcode")</c></item>
	/// </list>
	/// </example>
